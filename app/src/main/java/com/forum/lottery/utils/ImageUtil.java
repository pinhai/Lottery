...
/**
 * Created by Archer.su on 2014/12/3.
 */
public class ImageUtil {
    ...
    public static void loadImage(String url, ImageView imageView, int defaultImg){
        ...
        ImageLoader.getInstance().displayImage(url, imageView, getDefaultDisplayImageOptions(defaultImg));
    }

    public static void loadImage(String url, ImageView imageView){
        loadImage(url, imageView, R.drawable.transparent);
    }

    public static DisplayImageOptions getDefaultDisplayImageOptions(int defaultImg){
