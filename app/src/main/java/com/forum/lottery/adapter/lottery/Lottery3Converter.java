...
public class Lottery3Converter extends LotteryBaseConverter {
    @Override
    protected void setViewHolder(ViewHoldHelper holdHelper, LotteryVO item, int position) {
        TextView[] tv_num = {holdHelper.findView(R.id.tv_num1),
                ...
                holdHelper.findView(R.id.tv_num8),
                holdHelper.findView(R.id.tv_num9),
                holdHelper.findView(R.id.tv_num10)
        };
    ...
    public int getLayoutId() {
        return R.layout.list_lottery_item_3_view;
    }
}
